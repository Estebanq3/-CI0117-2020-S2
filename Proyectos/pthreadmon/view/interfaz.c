...
static void show_hiden_window(){
	...
	gtk_label_set_text(GTK_LABEL(descripcion[27]), "Pokemon1P1:");
	gtk_label_set_text(GTK_LABEL(descripcion[28]), "Pokemon2P1:");
	gtk_label_set_text(GTK_LABEL(descripcion[29]), "Pokemon3P1:");
	gtk_label_set_text(GTK_LABEL(descripcion[30]), "Pokemon1P2");
	gtk_label_set_text(GTK_LABEL(descripcion[31]), "Pokemon2P2");
	gtk_label_set_text(GTK_LABEL(descripcion[32]), "Pokemon3P2");
	gtk_label_set_text(GTK_LABEL(descripcion[33]), "DuracionTotalPelea:");
	gtk_label_set_text(GTK_LABEL(descripcion[34]), "Player1:");
	gtk_label_set_text(GTK_LABEL(descripcion[35]), "Player2:");
